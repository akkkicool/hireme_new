...
--
-- Host: localhost
-- Generation Time: Jan 03, 2021 at 07:44 PM
...
--
-- Table structure for table `etrade`
--
...
--
-- Dumping data for table `etrade`
--

INSERT INTO `etrade` (`id`, `obj`, `created_at`) VALUES
(1, 'O:53:\"League\\OAuth1\\Client\\Credentials\\TemporaryCredentials\":2:{s:13:\"\0*\0identifier\";s:44:\"2NVPYu27KpyEY8CY2g6xi9jliNqOETPv1AQj76B6GbQ=\";s:9:\"\0*\0secret\";s:44:\"vsy2ls31S+NAeJRIV3qJDMLcmX+ERFrw9datMp3tCvQ=\";}', '2020-12-21 14:43:03');
...
--
-- Table structure for table `freelance_categories`
--
...
--
-- Table structure for table `freelance_sub_categories`
--

CREATE TABLE `freelance_sub_categories` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
...
--
-- Indexes for table `freelance_categories`
--
ALTER TABLE `freelance_categories`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `freelance_sub_categories`
--
ALTER TABLE `freelance_sub_categories`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `etrade`
--
ALTER TABLE `etrade`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `freelance_categories`
--
ALTER TABLE `freelance_categories`
...
--
-- AUTO_INCREMENT for table `freelance_sub_categories`
--
ALTER TABLE `freelance_sub_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
