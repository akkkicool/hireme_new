...
class SubCategoryController extends Controller{
    ...
    protected $slug         =   'category/sub-categories';
    protected $page_title   =   'Sub Category';
    ...
    public function index(Request $request){
        ...
        $query          =   Category::select("*")->whereNotNull('parent_id');
        ...
        return view('admin.sub_category.index',compact('counter','records'));
    }
    ...
    public function edit($id,Request $request){
        if($request->isMethod('post')){
            ...
            $email_content->parent_id   =   $request['parent_id'];
            $email_content->save();
            ...
            $parent = Category::whereNull("parent_id")->where("status",1)->where("is_deleted",0)->pluck('name', 'id');
            if(!empty($record)){
                return view('admin.sub_category.edit',compact('record','parent'));
            }else{
    ...
    public function create(Request $request){
        if($request->isMethod('post')){
            ...
            return view('admin.sub_category.add', compact('parent'));
        }
    }
