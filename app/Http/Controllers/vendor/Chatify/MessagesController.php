...
class MessagesController extends Controller
{
    ...
    public function idFetchData(Request $request)
    {
        ...
        return Response::json([
            'favorite' => $favorite,
            'fetch' => $fetch,
            'user_avatar' => asset('/public/' . config('chatify.user_avatar.folder') . '/' . $fetch->image),
        ]);
    }
    ...
    public function search(Request $request)
    {
        ...
        $records = User::where('id','!=', Auth::user()->id)->where('first_name', 'LIKE', "%{$input}%")->orwhere('last_name', 'LIKE', "%{$input}%");
