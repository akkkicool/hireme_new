	  	...
	  	<div class="row">
			<div class="col-xs-12">
				<div class="box box-primary">
					<!-- /.box-header -->
					<div class="box-body">
						{{ Form::model($data, array( "method" => "post", "id"=>"editPatientForm", "enctype"=>"multipart/form-data", 'url' => url('admin').'/'.$slug.'/edit/'.base64_encode($data->id).getUrlParams(), "autocomplete"=>"off" )) }}
							...
							<div class="form-group">
								...
								<br/>
								{{ Form::tel("phone_number",($data->country_code.$data->mobile_number),array("class"=>"form-control intl_mobile_number","placeholder"=>"Mobile Number")) }}
							...
							<div class="row">
								...
								<div class="col-sm-6">
									<div id="imgContainer" style="margin-bottom: 5px;">
										@if($data->image)
												<img src="{{ url('public/uploads/users/thumbnail_image').'/'.$data->image }}" style="width:100px;height:100px;" />
										@endif
									</div>
								</div>
							</div>	
