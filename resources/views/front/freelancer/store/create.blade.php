				...
				<div class="row">
					...
					<div class="col-lg-9 col-md-8 mainpage">
						...
						<div class="jobs_manage">
							<div class="row">		
								<div class="col-lg-12">
									{{ Form::open(array('id'=>'updateService','url'=>route('store_create'),'enctype'=>'multipart/form-data', 'autocomplete' => "off")) }}
...
<script>
 	var _token = '{{ csrf_token() }}';
		 ...
		 //        bootstrapValidator.enableFieldValidators(startbox, !$(this).prop('checked'));
		 //        bootstrapValidator.enableFieldValidators(endbox, !$(this).prop('checked'));
		 //        $(startbox).prop("enable", $(this).prop('checked'));
		 //        $(endbox).prop("enable", $(this).prop('checked'));
		 //    });
		</script>
