								...
								<div class="col-lg-3">
									<div class="jobs_tabs">
										<ul class="nav job_nav nav-tabs" id="myTab" role="tablist">
											...
											<li class="nav-item">
												<a class="nav-link" href="#my_services" id="my-profile-tab" data-toggle="tab">Service Details</a>
											</li>
								...
								<div class="col-lg-9">
									<div class="tab-content" id="myTabContent">
										<div class="tab-pane fade show active" id="my_profile" role="tabpanel">
											@include('front/freelancer/tabs/profileForm')
										</div>
										<div class="tab-pane fade show" id="my_services" role="tabpanel">
											<div class="view_chart">
												@include('front/freelancer/tabs/serviceForm')
											</div>
										</div>
										<div class="tab-pane fade" id="social_accounts">
											<div class="view_chart">
												@include('front/freelancer/tabs/socialForm')
											</div>
										</div>
										<div class="tab-pane fade" id="change_password">
											<div class="view_chart">
												@include('front/freelancer/tabs/changePassForm')
											</div>
										</div><!-- 
