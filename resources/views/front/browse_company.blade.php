									...
									<div class="lg-item5 col-lg-6 col-xs-6 grid-group-item5">
										<div class="job-item mt-30">
											<div class="job-top-dt1 text-center">
												<div class="job-center-dt">
													...
													<div class="job-urs-dts">
														<a href="#"><h4>Gambol Themes</h4></a>
														<a href="#" class="avialable c-link">www.gambolthemes.net</a>
													</div>													
												</div>	
											</div>
											...
											<div class="job-buttons">
												<ul class="link-btn">
													<li class="cpy-btn"><a href="other_company_profile.html" class="link-j1" title="View Profile">View Profile</a></li>
										...
										<div class="job-item mt-30">
											<div class="job-top-dt1 text-center">
												<div class="job-center-dt">
													...
													<div class="job-urs-dts">
														<a href="#"><h4>Plame Designs</h4></a>
														<a href="#" class="avialable c-link">www.plamedesigns.net</a>
													</div>													
												</div>	
											</div>
											<div class="rating-location">
										...
										<div class="job-item mt-30">
											<div class="job-top-dt1 text-center">
												<div class="job-center-dt">
													...
													<div class="job-urs-dts">
														<a href="#"><h4>Sofwebtech</h4></a>
														<a href="#" class="avialable c-link">www.sofwebtech.net</a>
													</div>													
												</div>	
											</div>
											<div class="rating-location">
										...
										<div class="job-item mt-30">
											<div class="job-top-dt1 text-center">
												<div class="job-center-dt">
													...
													<div class="job-urs-dts">
														<a href="#"><h4>Multimedia Web</h4></a>
														<a href="#" class="avialable c-link">www.multimediaweb.net</a>
													</div>													
												</div>	
											</div>
											<div class="rating-location">
